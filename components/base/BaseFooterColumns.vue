      ...
      <div v-for="(link, index) in links" :key="index">
        ...
        <ul role="list" :class="ui.list">
          <li v-for="(subLink, subIndex) of link.children" :key="subIndex">
            <ULink v-bind="getULinkProps(subLink)" :to="subLink.to" :class="ui.base" :active-class="ui.active"
              :inactive-class="ui.inactive" @click="subLink.click">
              {{ subLink.label }}
...
const config = computed(() => ({
  wrapper: 'xl:grid xl:grid-cols-6 xl:gap-8',
  left: 'mb-10 xl:mb-0',
  center: 'flex flex-col grid grid-flow-col auto-cols-fr gap-8 xl:col-span-3',
  right: 'mt-10 xl:mt-0 xl:col-span-3',
